    ...
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-base text-slate-600">
          Drop in the ZIP you downloaded from Spotify or any <code className="rounded bg-slate-100 px-1">Streaming_History*.json</code> file.
        ...
        {totalPlays > 0 && (
          <p className="text-sm text-slate-500">
            ...
            <Link href="/overview" className="font-medium text-emerald-600 underline">
