...
export function SourceManager() {
  ...
  if (!hasSources) {
    return (
      <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-5 py-6">
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="rounded-md border border-slate-200 dark:border-slate-600 px-3 py-1.5 text-sm font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-slate-700"
          ...
          <button
            type="button"
            className="rounded-md border border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-900/30 px-3 py-1.5 text-sm font-medium text-rose-700 dark:text-rose-300 transition hover:bg-rose-100 dark:hover:bg-rose-900/50"
      ...
      <ul className="space-y-3">
        {sources.map((source) => (
          <li
            key={source.id}
            className="flex flex-col gap-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between"
          >
            <div className="w-full sm:max-w-md">
              ...
              <input
                type="text"
                className="mt-1 w-full rounded-md border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-3 py-2 text-sm text-slate-800 dark:text-slate-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
                value={source.name}
